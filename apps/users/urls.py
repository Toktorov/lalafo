...
from apps.users.views import register, user_login, profile, profile_update, profile_delete, user_favorites, user_favorite_delete, comment_user, comment_index
...
urlpatterns = [
    ...
    path('comments/', comment_index, name = "comment_index"),
]